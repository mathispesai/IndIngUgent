...
public class PioneerTest {
    ...
    @Test
    public void testPioneerShouldTravel() {
        ...
        var unit = new Unit(1, 0, UnitType.PIONEER, 1, 4, false, false);
    ...
    @Test
    public void testPioneerShouldConquer() {
        var baseLocation = new Location(0, 0, false, false, false, false, 0, null);
        // Faction with maximum amount of gold and sufficient population capacity
        var faction = new Faction(0, "TestFaction", baseLocation, 500L, 0, 200, 0, 20,
                0, 0, false, 0);
        ...
        var unit = new Unit(1, 0, UnitType.PIONEER, 1, 4, false, false);
        var unitLocation = new Location(5, 5, false, false, false, false, null, unit);
        var neighbors = getNeighborLocations();
    ...
    @Test
    public void testPioneerShouldNeutralize() {
        var baseLocation = new Location(0, 0, false, false, false, false, 0, null);
        // Faction with maximum amount of gold and sufficient population capacity
        var faction = new Faction(0, "TestFaction", baseLocation, 500L, 0, 200, 0, 20,
                0, 0, false, 0);
