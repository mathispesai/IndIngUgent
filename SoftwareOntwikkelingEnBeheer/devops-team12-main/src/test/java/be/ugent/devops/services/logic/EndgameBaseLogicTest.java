...
@QuarkusTest
public class EndgameBaseLogicTest {
    ...
    private static GameContext context = new GameContext(1200, "test", 100, 50, bogusUnitBaseHealth, bogusUnitCost, bogusUnitMoveCost);
    ...
    @BeforeEach
    public void setUp() {
        context = new GameContext(1200, "test" + rand.nextInt(10000), 100, 50, bogusUnitBaseHealth, bogusUnitCost, bogusUnitMoveCost);
    }
    ...
    public void testFactionBuildsPioneer() {
        ...
        customContext.units.get(UnitType.CLERIC).put(2, new UnitInfo(1, UnitBehavior.CONVERT_OPPONENTS, tile));
